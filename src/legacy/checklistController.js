...
const DRAFT_MEDIA_KEY = "normatel_checklist_critico_media";
const DRAFT_KEY = `checklist_draft_critico_${AUTH.id}`;
...
function modalImprimir() {
  openModal(
    "Imprimir checklist",
    `<div class="m-help">Escolha se deseja abrir a impressão do navegador ou gerar um PDF do checklist atual.</div>`,
    `
